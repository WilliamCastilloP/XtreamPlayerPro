...
const en = {
  ...
  playerTrackOff: "Off",
  playerTrackDefault: "Default",
  playerSubsLoading: "Loading subtitles…",
  playerSubsUnsupported: "This subtitle format can’t be shown in the browser.",
  favorite: "Favorite",
  play: "Play",
  back: "Back",
} as const;
...
const es: Record<MessageKey, string> = {
  ...
  playerTrackOff: "Desactivados",
  playerTrackDefault: "Principal",
  playerSubsLoading: "Cargando subtítulos…",
  playerSubsUnsupported: "Este formato de subtítulo no se puede mostrar en el navegador.",
  favorite: "Favorito",
  play: "Play",
  back: "Atrás",
};
