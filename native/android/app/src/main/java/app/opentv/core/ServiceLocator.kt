    ...
    class Graph(context: Context) {
        ...
        val httpClient: OkHttpClient by lazy {
            OkHttpClient.Builder()
                ...
                // VOD catalogues on a busy panel can stream for many minutes. A short
                // read timeout kills the download mid-list; the Fire Stick then shows
                // "this provider returned no movies". Keep the connection alive as long
                // as bytes keep arriving, and allow a long overall call.
